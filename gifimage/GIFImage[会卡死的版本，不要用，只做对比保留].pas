...
////////////////////////////////////////////////////////////////////////////////
  ...
  protected
    ...
    procedure Warning(Severity: TGIFSeverity; const Message: string); virtual;
  public
...
////////////////////////////////////////////////////////////////////////////////
  ...
  protected
    ...
    procedure Warning(Severity: TGIFSeverity; const Message: string); virtual; abstract;
  ...
  public
    ...
    class function RGB2Color(const Color: TGIFColor): TColor;
    ...
    procedure ImportColorMap(const Map: TColorMap; Count: integer);
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public
    ...
    procedure SaveToStream(Stream: TStream); override;
    procedure LoadFromStream(Stream: TStream); override;
    class procedure RegisterExtension(const eIdent: TGIFApplicationRec; const eClass: TGIFAppExtensionClass);
...
{$endif}
  ...
  TGIFWarning = procedure(Sender: TObject; Severity: TGIFSeverity; const Message: string) of object;
...
{$ENDIF}
  public
    ...
    procedure Warning(Sender: TObject; Severity: TGIFSeverity; const Message: string); virtual;
    procedure Assign(Source: TPersistent); override;
...
class function TGIFColorMap.RGB2Color(const Color: TGIFColor): TColor;
begin
...
procedure TGIFColorMap.ImportColorMap(const Map: TColorMap; Count: integer);
begin
  Clear;
  if (Count = 0) then
    exit;
...
procedure TGIFItem.Warning(Severity: TGIFSeverity; const Message: string);
begin
...
procedure TGIFList.Warning(Severity: TGIFSeverity; const Message: string);
begin
...
type
  ...
  private
    FHeader	: TGIFHeader;
  protected
    procedure Warning(Severity: TGIFSeverity; const Message: string); override;
...
procedure TGIFGlobalColorMap.Warning(Severity: TGIFSeverity; const Message: string);
begin
...
procedure TGIFLocalColorMap.Warning(Severity: TGIFSeverity; const Message: string);
begin
...
type
  ...
  public
    constructor Create;
    destructor Destroy; override;
    procedure Add(const eIdent: TGIFApplicationRec; const eClass: TGIFAppExtensionClass);
    function FindExt(const eIdent: TGIFApplicationRec): TGIFAppExtensionClass;
    procedure Remove(const eClass: TGIFAppExtensionClass);
  end;
...
procedure TAppExtensionList.Add(const eIdent: TGIFApplicationRec; const eClass: TGIFAppExtensionClass);
var
  NewRec: PAppExtRec;
begin
  New(NewRec);
...
function TAppExtensionList.FindExt(const eIdent: TGIFApplicationRec): TGIFAppExtensionClass;
var
  I: Integer;
begin
  for I := Count-1 downto 0 do
...
procedure TAppExtensionList.Remove(const eClass: TGIFAppExtensionClass);
var
  I: Integer;
  P: PAppExtRec;
begin
...
class procedure TGIFApplicationExtension.RegisterExtension(const eIdent: TGIFApplicationRec;
  const eClass: TGIFAppExtensionClass);
begin
...
procedure TGIFImage.Warning(Sender: TObject; Severity: TGIFSeverity; const Message: string);
begin
...
{$IFNDEF VER9x}
  ...
  {$ENDIF}
  {$IFDEF VER100}
  if Assigned(pf8BitBitmap) then pf8BitBitmap.Free;
  {$ENDIF}
{$ENDIF}
{$IFDEF VER12_PLUS}
{$IFNDEF TEEOCX}
  if Assigned(DummyThread) then DummyThread.Free;
{$ENDIF}
{$ENDIF}
end.
